...
import DeleteConfirmationModal from "../components/DeleteConfiramationModal";
...
const Customers: React.FC = () => {
    ...
    const handleConfirm = () => {
        // Perform delete action here, e.g., make an API call to delete the customer
                        ...
                        {customers.map((customer) => (
                            <tr key={customer.id} className="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td className="py-3 px-6 text-left flex space-x-4">
                                    ...
                                    <button onClick={() => handleDeleteClick(customer)} className="text-red-500 hover:text-red-700 focus:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
